  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        [data-theme="dark"] .click-hand-light { display: block; }
        [data-theme="dark"] .click-hand-dark { display: none; }
        :root:not([data-theme="dark"]) .click-hand-dark { display: block; }
        :root:not([data-theme="dark"]) .click-hand-light { display: none; } } .glimpse-card:hover {
