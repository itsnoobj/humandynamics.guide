...
/**
 * Mission map for a region (level 3 of the navigation hierarchy). Reads the
 * world and region ids from the route and renders the region's missions.
 */
export function RegionClient() {
  return (
