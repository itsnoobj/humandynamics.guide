...
import availableJson from '../../../content/available.json';
...
/**
 * Chapter IDs that have content (generated by tools/sync-assets.sh).
 * Used to determine locked/unlocked state at all navigation levels.
 */
export const availableChapterIds: Set<string> = new Set(availableJson as string[]);
